      ...
      <section class="wrapper wrapper-content">
        ...
        <div class="ibox float-e-margins">
          ...
          <div class="ibox-content">
            ...
            <form id="form" method="post" class="form-horizontal" action="/class" enctype="multipart/form-data">
              @csrf
              <input type="hidden" name="action" value="{{$action}}" />
              <input type="hidden" name="id" value="@if($class) {{$class->getId()}} @endif" />
              <input type="hidden" name="main_class_id" value="@if($class) {{$class->getMainClassId()}} @endif" />

              <div class="form-group">
                <label class="col-sm-2 control-label">Stare curs:</label>
                <div class="col-sm-2"><label> <input type="checkbox" name="active" @if($class && $class->isActive()) checked="checked"
                    @endif value="1"> Publicat <small>apare pe
                      site </small></label></div>
                <div class="col-sm-2"><label> <input type="checkbox" name="weekend" @if($class && $class->isInWeekend()) checked="checked"
                    @endif value="1"> Weekend </label></div>
                <div class="col-sm-2"><label> <input type="checkbox" name="bucharest" @if($class && $class->isBucharestLocated()) checked="checked"
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label">Suplimentar:<br /><small>Iterare, nu apare pe
                    site</small></label>
                <div class="col-sm-4"><input value="@if($class) {{$class->getTitle()}} @endif" name="title" type="text" class="form-control" required>
                </div>
              </div>
              <div class="hr-line-dashed"></div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Descriere scurta:<br /><small>Slogan
                    curs</small></label>
                <div class="col-sm-10"><input value="@if($class) {{$class->getShortDescription()}} @endif" name="short_description" type="text" class="form-control" required></div>
              </div>
              <div class="hr-line-dashed"></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"><input value="@if($class){{$class->getStudents()}}@endif" name="students" type="text" placeholder="doar cifre" class="form-control" required></div>
              </div>
              <div class="hr-line-dashed"></div>

              <div class="form-group">
                <label class="col-sm-2 control-label">Pret curs/cursant:</label>
                <div class="col-sm-10"><input value="@if($class){{$class->getPrice()}}@endif" name="price" type="text" placeholder="doar cifre" class="form-control" required></div>
              </div>
              <div class="hr-line-dashed"></div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="select2 form-control" name="trainer" required>
                    ...
                    <option value="{{$trainer->getId()}}" @if($class && in_array($class->getId(), $trainer->classTrainers->pluck('class_id')->toArray()))
                      selected="selected"
                      @endif
              ...
              <div class="form-group" id="calendar-dates">
                ...
                <div class="col-sm-10">
                  ...
                  <br />
                  <div id="removeDates" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-trash"></i> &nbsp; Sterge Datele</div>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Loc desfasurare: <br /><small>Online sau o
                    locatie</small></label>
                <div class="col-sm-10">
                  <input type="text" name="deploymentCourse" id="desfasurarecurs" class="form-control" value="@if($class) {{$class->getDeployment()}} @endif">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Program weekdays:</label>
                <div class="col-sm-10">
                  <input type="text" name="weekdays_schedule" class="form-control" value="@if($class){{$class->getWeekdaysSchedule()}}@endif">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Program weekend:</label>
                <div class="col-sm-10">
                  <input type="text" name="weekend_schedule" class="form-control" value="@if($class){{$class->getWeekendSchedule()}}@endif">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <p class="help-block"><a href="{{$class->getSchedulePdf()}}" target="_blank" />{{$class->schedule_pdf}}</a></p>
                  <a class="btn btn-primary btn-sm" href="<?php echo basename($_SERVER["REQUEST_URI"]); ?>&removepdf={{$class->getId()}}"><i class="glyphicon glyphicon-trash"></i> &nbsp; Sterge programa</a>
                  @else
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <p class="help-block"><img src="{{$class->getImage()}}" width="250" /></p>
                  <a class="btn btn-primary btn-sm" href="<?php echo basename($_SERVER["REQUEST_URI"]); ?>&removeimage={{$class->getId()}}"><i class="glyphicon glyphicon-trash"></i> &nbsp; Sterge imaginea</a>
                  @else
                  <div class="inputBtnSection">
