...
<main>
    <div class="upt-form upt-form--resister">
        <form class="form-horizontal" role="form" method="POST" action="/register">
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" autofocus class="upt-form__input"
          ...
          <strong>{{ $errors->first('name') }}</strong>
            ...
            <input id="email" type="email" name="email"
                   @if(request()->get('email')) value="{{ request()->get('email')}}" @else value="{{ old('email') }}"
                   @endif class="upt-form__input" placeholder="Enter your e-mail">
            @if ($errors->has('email'))
                <span class="help-block">
          ...
          <strong>{{ $errors->first('password') }}</strong>
            ...
            @endif
            <input id="password-confirm" type="password" class="upt-form__input" name="password_confirmation"
