...
<<<<<<< HEAD:resources/views/class_signup_form.blade.php
        <link rel="manifest" href="{{asset('favicon/manifest.json')}}">
=======
        <link rel="manifest" href="favicon/manifest.json">
>>>>>>> marian/features/signup-view:resources/views/students/class_signup_form.blade.php
...
>>>>>>> marian/features/signup-view:resources/views/students/class_signup_form.blade.php
                                    ...
                                    <div class="row entry-content">
                                        ...
                                        <div class="col-sm-12 col-md-2">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="modalitate_plata" id="inlineRadio0"
                                                           value="banca"
                                                           checked="">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="tip_plata" id="inlineRadio1"
                                                           value="integral"
                                                           checked="">
                                                    Integral </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="tip_plata" id="inlineRadio2"
                                                           value="doua_rate">
                                                    Două rate </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="tip_plata" id="inlineRadio3"
                                                           value="trei_rate">
                                                    Trei rate </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="conditii_minime"
                                                       value=""
                                                       required="">
                                    ...
                                    <input name="cursant" class="form-control" value="{{ $signupData['student']->id }}"
                                           type="hidden">
                                    <input name="numecurs" class="form-control"
                                           value="{{ $signupData['mainClass']->title }} - {{ $class->title }}"
                                           type="hidden">
                                    <input name="datacurs" class="form-control"
                                           value="{{ $class->registration_start_date }}" type="hidden">
                                    <input name="cost" class="form-control" value="{{ $class->price }}"
                                           type="hidden">
