              ...
              <div class="ibox-content">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="m-b-md">
                      <button type="button" class="btn btn-warning btn-xs pull-right" data-toggle="modal" data-target="#mesaj">Adrese email cursanti
                      </button>
                    </div>
                    @endif
                    ...
                    <dl class="dl-horizontal">
                      ...
                      <dd>
                        <div class="progress progress-striped active m-b-sm">
                          <div style="width: {{$class->getOccupancyRate()}}%" class="progress-bar"></div>
                        </div>
                      </dd>
                    </dl>
                  </div>
                          ...
                          <tbody>
                            ...
                            <tr @if($classStudent->getPaymentStatus()=='Plata in asteptare') class="warning" @endif>
                              ...
                              <td class="text-center">
                                <button href="/inline_move_student?student={{$classStudent->getStudentId()}}&class={{$class->getId()}}" class="btn btn-warning btn-xs ajax-popup-link">
                                  Muta
                                </button>
                              </td>
                              <td class="text-center">
                                @if(!$classStudent->student->feedback($class->getId()))
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#calificativ{{$classStudent->getId()}}">
                                  Calificativ
                                </button>
                                <div class="modal inmodal" id="calificativ{{$classStudent->getId()}}" tabindex="-1" role="dialog" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                      <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Inchide</span>
                                        </button>
                                        ...
                                        <form method="POST" class="calificativ" action="">
                                            ...
                                            <div class="col-md-12 form-horizontal">
                                              <fieldset>
                                                ...
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio1" value="1" name="grade">
                                                  <label for="inlineRadio1">
                                                    1 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio2" value="2" name="grade">
                                                  <label for="inlineRadio2">
                                                    2 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio3" value="3" name="grade">
                                                  <label for="inlineRadio3">
                                                    3 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio4" value="4" name="grade">
                                                  <label for="inlineRadio4">
                                                    4 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio5" value="5" name="grade">
                                                  <label for="inlineRadio5">
                                                    5 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio6" value="6" name="grade">
                                                ...
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio8" value="8" name="grade">
                                                  <label for="inlineRadio8">
                                                    8 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio9" value="9" name="grade">
                                                  <label for="inlineRadio9">
                                                    9 </label>
                                                </div>
                                                <div class="radio radio-inline">
                                                  <input type="radio" id="inlineRadio10" value="10" name="grade">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-6">Good
                                              points
                                              <textarea name="organization_jira_zephyr_plus"></textarea>
                                            </div>
                                            <div class="col-md-6">To
                                              improve
                                              <textarea name="organization_jira_zephyr_minus"></textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">Good
                                              points<textarea name="test_cases_plus"></textarea>
                                            </div>
                                            <div class="col-md-6">To
                                              improve<textarea name="test_cases_minus"></textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">Good
                                              points<textarea name="defects_plus"></textarea>
                                            </div>
                                            <div class="col-md-6">To
                                              improve<textarea name="defects_minus"></textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">Good
                                              points<textarea name="traceability_plus"></textarea>
                                            </div>
                                            <div class="col-md-6">To
                                              improve<textarea name="traceability_minus"></textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <div class="col-md-12 mt-20 text-center">
                                              <button class="btn btn-info btn-sm" type="submit" name="feedback" />
                                              Salvează
                                              calificativ</button>
                                            </div>
                                          </div>
                                      ...
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-white" data-dismiss="modal">Inchide
                                        </button>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                @else
                                <a href="/feedback/{{$classStudent->student->feedback($class->getId())->getLink()}}" class="btn btn-warning btn-xs" target="_blank">Calificativ</a>
                                @endif
                              </td>
                              <td class="text-center">
                                <button href="/inline_note?student={{$classStudent->getStudentId()}}&class={{$class->getId()}}" class="btn @if(!is_null($classStudent->getNote())) btn-primary @else btn-info @endif btn-xs ajax-popup-link">
                                  Notita
                                </button>
                              </td>
                              <td class="text-center">
                                <form action="" method="GET">
                                  ...
                                  Sterge</button>
                                  <input type="hidden" name="delete" value="{{$classStudent->getStudentId()}}" />
                                  <input type="hidden" name="class" value="{{$class->getId()}}" />
                                </form>
                              </td>
                            </tr>
