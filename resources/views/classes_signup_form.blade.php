                    ...
                    <div class="section-content post">
                        <form id="inscriere_curs" name="inscriere_curs" class="reservation-form" method="post"
                            ...
                            <div class="row">
                                ...
                                @if (Auth::student()->isSignedUp()) <!--TODO de definit -->
                            ...
                            <input name="cursant" class="form-control" value="{{ Auth::student()->id }}"
                                   type="hidden">
                            <input name="numecurs" class="form-control"
                                   value="{{ $mainCourse->title }} - {{ $course->title }}"
                                   type="hidden">
                            <input name="datacurs" class="form-control"
                                   value="{{ $course->registration_start_date }}" type="hidden">
                            <input name="cost" class="form-control" value="{{ $course->price }}"
                                   type="hidden">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="pl-50 pr-50 pb-50">
                        ...
                        <h2 class="modal-title" id="myModalLabel2">{{ $termsOfService->title }}</h2>
                        <hr/>
                        {{ $termsOfService->text }}
                    </div>
                </div>
